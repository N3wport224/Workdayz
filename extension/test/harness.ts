...
import { applyAnswers, findEmptyRequiredFields, findQuestionFields, parseDateParts, previewAutofill, runAutofill } from "../src/content/autofill";
...
window.WorkdayzTest = { runAutofill, previewAutofill, findQuestionFields, findEmptyRequiredFields, applyAnswers, parseDateParts, undoFill };
